            ...
            <div class="panel panel-color panel-primary panel-pages">
                ...
                <form class="form-horizontal m-t-20" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="form-group ">
                        <div class="col-xs-12">
                            <input class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }} input-lg " type="email" id="email" name="email" value="{{ old('email') }}" placeholder="E-Mail Address" required autofocus>
